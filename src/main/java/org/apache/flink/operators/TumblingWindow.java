...
public class TumblingWindow {
    ...
    // TumblingWindow的运行方式：每隔指定时间,计算当前窗口数据，窗口之间不重叠；例如：每隔5秒，执行5秒内窗口的数据，
    // 注意：跟启动的时间没有关系，如果是每隔5s一次，1分钟会被分为12次，分别在05,10,15,20,25,30,35......执行。
    // >>> 23:50:05 执行 23:50:00 - 23:50:05的数据。
    // >>> 23:50:10 执行 23:50:05 - 23:50:10的数据。
    // >>> ......
    ...
    public static void main(String[] args) throws Exception {
        ...
        }).keyBy(0).windowAll(TumblingProcessingTimeWindows.of(Time.seconds(10))).maxBy(1).print();
        env.execute();
    }
}
